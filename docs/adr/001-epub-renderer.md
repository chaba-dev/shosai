...
cells. Paginated tables fragment only between complete row-span bands and keep
the original text offsets; a band taller than one page remains intact rather
than splitting cell content.
