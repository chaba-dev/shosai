...
|----------------------------|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|--------------------------------------------------------|
| CSS/table/MathML fidelity  | Promising on macOS system WebKit                                                                              | Production cascade, CSS resources, embedded font shaping/rasterization, inline and table flow, normalized grid tables, and bounded native/fallback MathML pass the combined packaged-app fixture on macOS arm64 and Linux x86_64 | Accessibility semantics and broader CJK/emoji coverage |
