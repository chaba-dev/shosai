...
|----------------------------|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|--------------------------------------------------------|
| CSS/table/MathML fidelity  | Promising on macOS system WebKit                                                                              | Production cascade, CSS resources, embedded font shaping/rasterization, inline flow, table fallback/model, and bounded native/fallback MathML pass the combined packaged-app fixture on macOS arm64 and Linux x86_64/X11 | Linux arm64/Wayland visual evidence, accessibility semantics, and broader CJK/emoji coverage |
...
| Reader-feature integration | Host-owned Linux/X11 proof applies theme/font size, internal fragment navigation, search highlighting, stable path/fragment/text-offset restoration, and continuous/paginated CSS modes | Production native presentation preserves multi-chapter navigation, TOC, search/highlighting, bookmarks, progress, themes, font sizing, and paginated/continuous modes; packaged macOS and Linux pointer/keyboard smoke tests pass | Screen-reader and selection support                    |
